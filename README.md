...
*DB다이어그램 넣기
*실행방법 넣기
*보안 상의 문제로, LMS에서 진행하는 온라인 시험은 웹을 통해야 함
```
...
### [LMS: 강의실 화면]
* **강의실 화면**
  - 강의리스트에서 특정 강의를 선택하여 진입하는 화면
  - 진입 시 과목공지 페이지 표기
  - 좌우 방향 스크롤을 통한 페이지 이동
* **과목공지 화면**
  - [상단] 강의실 확인
  - [중단 스크롤] 게시된 공지 목록 확인
* **학습자료 화면**
  - [상단] 강의실 확인
  - [중단 스크롤] 게시된 학습자료 목록 확인
* **과제제출 화면**
  - [상단] 강의실 확인
  - [중단 스크롤] 게시된 과제 목록 확인
  - [과제 카드] 제출 여부를 직관적으로 표기
* **수강 화면**
  - [상단] 강의실 확인
  - [중단 스크롤] 게시된 온라인 강의 목록 확인
  - [수강 카드] 주차, 주차 기준 학습기간, 회차 정보, 수강 여부 등 표기
 
| 과목공지 화면 | 학습자료 화면 | 과제제출 화면 | 수강 화면 |
|------|------|------|------|
